...
var histogram_eeg = null ;
var histogram_pi  = null ;
var histogram_mm  = null ;
var histogram     = null ;
var plot_space    = null ;
var plot_space_ee = null ;
var events = [] ;
...
function start(){
  ...
  histograms['phi'     ] = new histogram_object('mass (KK)'        ,  950,  1300,  35, 'MeV',   '0,100,0') ;
  histograms['Ds'      ] = new histogram_object('mass (KKπ)'       , 1500,  2500,  30, 'MeV',   '0,0,255') ;
  histograms['Ds_tight'] = new histogram_object('mass (KKπ) tight' , 1500,  2500,  30, 'MeV', '0,100,100') ;
  histograms['q'       ] = new histogram_object('quark pdgId'      ,  0.5,   4.5,   4,    '',   '0,255,0') ;
  histograms['jm'      ] = new histogram_object('jet mass'         , 1000,  6000,  50, 'MeV',   '255,0,0') ;
  histograms['KS'      ] = new histogram_object('mass (ππ)'        ,  200,  1300,  44, 'MeV', '200,0,200') ;
  histograms['K0Star892'   ] = new histogram_object('mass (K+π-)'  ,  500,  1500,  25, 'MeV',  '50,50,50') ;
  histograms['K0BarStar892'] = new histogram_object('mass (K-π+)'  ,  500,  1500,  25, 'MeV',  '50,50,50') ;
...
function heartbeat(){
  ...
  if(!pause){
    ...
    if(counter%draw_interval==0) write_particle_info_table(particles) ;
    if(success){
